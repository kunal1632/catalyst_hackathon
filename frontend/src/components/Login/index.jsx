...
const LogIn = () => {
  const { isLoading, login, loginErrors, resetPassword, googleSignIn } = useAuth();

  const navigate = useNavigate();
  const [formData, setFormData] = useState({
    email: "ayushjain1953@gmail.com", password: "Qwerty@123",
  })
  ...
  return (
    <form
      ...
      <label className=" relative w-full">
        ...
        <button onClick={handleForgetPassword} type='button' className="text-xs mt-1 text-blue-100 max-w-max ml-auto">
          Forgot Password
        </button>
