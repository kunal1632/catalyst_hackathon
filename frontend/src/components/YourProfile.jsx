      ...
      <div className="flex px-5 pb-5 justify-between mt-10 ml-48">
        ...
        <div className="flex items-center gap-3">
          {isMe ? (
            <Link
              to={"/edit-profile/"}
              className=" bg-LightPurple text-white px-[2.5rem] py-[0.5rem] rounded-lg outline-none bottom-7 right-7 hover:scale-110 hover:opacity-95 transition-all duration-150"
            >
              Edit Profile
            </Link>
          ) : (
